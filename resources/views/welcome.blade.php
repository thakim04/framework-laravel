...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div>
                <h2>Selamat Datang Di Pemrogaman Framework</h2>
            </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                framework. Whether
                                you are new to the framework or have previous experience with Laravel, we
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                projects to the next level. Pair them with
